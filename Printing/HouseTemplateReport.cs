...
namespace smpc_dispatching.Printing
{
    ...
    public class HouseTemplateReport
    {
        ...
        // Opens the preview through the app's own PrintService, so a house-template
        // print behaves exactly like the Delivery Receipt and Item Release prints.
        public void ShowPreview()
        {
            new smpc_dispatching.Core.Services.PrintService()
                .Show(ReportPath, DataSources(), Parameters());
        }
